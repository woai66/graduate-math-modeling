...
`templates/paper-skeleton.docx` 是可直接填写的论文骨架：**封面与摘要页直接沿用官方附件3 模板**（官方 logo、报名表格、华文新魏/隶书标题、页边距、页码起始 0），正文按附件2 的字体字号与优秀论文范式注入。已用 Microsoft Word 打开并导出 PDF 完成原生渲染验证（封面 0、摘要页 1、正文第 2 页起，无空白页）。用法见 [骨架使用说明](templates/paper-skeleton-usage.md)。
